    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          >
            <source
              src="/8320980-uhd_3840_2160_24fps.mp4"
              type="video/mp4"
            />
        ...
        <div className="relative z-10 text-center text-white px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg md:text-xl mb-8 text-gray-200 leading-relaxed">
              Discover the ideal rental property that fits your lifestyle and budget
            </p>
            
            {/* Trust Badge */}
            <div className="mt-8 bg-white/10 backdrop-blur-sm rounded-full px-6 py-3 inline-block">
              <p className="text-base">
                <span className="font-bold text-yellow-400">Trusted by 15,000+</span> renters
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Browse our curated selection of rental properties available now
            </p>
          </div>
