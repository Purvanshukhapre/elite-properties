...
const CallToAction = () => {
  ...
  return (
    <div className="py-20 px-4 bg-gradient-to-br from-blue-600 to-indigo-700 relative overflow-hidden">
      <motion.div
        className="absolute inset-0 bg-gradient-to-br from-accent-purple/10 to-accent-teal/10 opacity-20"
        animate={{
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <motion.button
                className="bg-white text-primary-blue font-bold py-4 px-8 rounded-xl hover:bg-opacity-90 transition-all relative overflow-hidden group"
              ...
              <motion.button
                className="bg-transparent border-2 border-white text-white font-bold py-4 px-8 rounded-xl hover:bg-white hover:text-primary-blue transition-all relative overflow-hidden group"
                whileHover={{ scale: 1.05, boxShadow: '0 15px 35px rgba(0, 0, 0, 0.3)' }}
                whileTap={{ scale: 0.95 }}
              >
