...
import { FaBed, FaBath, FaRulerCombined, FaHeart, FaMapMarkerAlt, FaCalendarAlt, FaMoneyBillWave } from 'react-icons/fa';
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          >
            <source
              src="/0_Real_Estate_Property_3840x2160.mp4"
              type="video/mp4"
            />
        ...
        <div className="relative z-10 text-center text-white px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg md:text-xl mb-8 text-gray-200 leading-relaxed">
              Get the best price for your home with our expert selling services
            </p>
            
            {/* Trust Badge */}
            <div className="mt-8 bg-white/10 backdrop-blur-sm rounded-full px-6 py-3 inline-block">
              <p className="text-base">
                <span className="font-bold text-yellow-400">Trusted by 15,000+</span> sellers
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-12">
              Our proven process ensures you get the best price for your property
            </p>
            
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transform transition-all duration-300 hover:-translate-y-2">
                ...
                <p className="text-gray-600">Get an accurate market valuation of your property at no cost</p>
              </div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transform transition-all duration-300 hover:-translate-y-2">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">Maximize Profit</h3>
                <p className="text-gray-600">Our strategies help you achieve the highest possible sale price</p>
              </div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transform transition-all duration-300 hover:-translate-y-2">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">Stress-Free</h3>
                <p className="text-gray-600">We handle all paperwork and negotiations for you</p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              See properties currently on the market with our agents
            </p>
          </div>
